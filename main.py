...
def bechoras():
  ...
  fig = px.bar(wide_df, x=BecNames, y=BecHoras,color=["species","species","species","species","species","species","species","species","species","species","species","species"], title="Wide-Form Input")
  st.plotly_chart(fig)
